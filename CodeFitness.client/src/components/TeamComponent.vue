<template>
  <section v-if="!account.community && account.id" class="row justify-content-around bg-neutral-dark ">
    ...
    <div @click="selectCommunity('Cardio Kings')" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center selectable flag">
      <div>
    ...
    <div @click="selectCommunity('Weight Warriors')" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center selectable flag">
      <div>
    ...
    <div @click="selectCommunity('Legion of Leisure')" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center selectable flag">
      <div>
  ...
  <section v-else class="row justify-content-around bg-neutral-dark">
    <div :class="{ 'highlight1 order-2': account.community == 'Cardio Kings' }" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center flag">
      <div>
        <img class="w-75" src="../assets/img/flagCK.png" alt="Cardio Kings">
        <p class="fs-2 pt-3 fw-bold">Cardio Kings</p>
      </div>
    ...
    <div :class="{ 'highlight2': account.community == 'Weight Warriors', 'order-3': account.community == 'Legion of Leisure' }" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center flag">
      <div>
        <img class="w-75" src="../assets/img/flagWW.png" alt="Cardio Kings">
        <p class="fs-2 pt-3 fw-bold">Weight Warriors</p>
      </div>
    ...
    <div :class="{ 'highlight3': account.community == 'Legion of Leisure', 'order-3': account.community == 'Cardio Kings' }" class="col-10 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 p-3 text-center flag">
      <div>
        <img class="w-75" src="../assets/img/flagLL.png" alt="Cardio Kings">
        <p class="fs-2 pt-3 fw-bold">Legion of Leisure</p>
      </div>
