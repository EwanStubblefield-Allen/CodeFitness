<template>
  <section v-if="!account.community && account.id" class="row justify-content-around bg-neutral-dark ">
    ...
    <div @click="selectCommunity('Cardio Kings')"
      class="col-4 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 py-3 px-1 text-center selectable flag highlight1">
      <div>
    ...
    <div @click="selectCommunity('Weight Warriors')"
      class="col-4 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 py-3 px-1 text-center selectable flag highlight2">
      <div>
    ...
    <div @click="selectCommunity('Legion of Leisure')"
      class="col-4 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 py-3 px-1 text-center selectable flag highlight3">
      <div>
  ...
  <section v-else class="row justify-content-around bg-neutral-dark">
    <div :class="{ 'highlight1 order-2': account.community == 'Cardio Kings' }"
      class="col-4 col-md-3 d-flex flex-column justify-content-between bg-neutral-light my-4 py-3 px-1 text-center flag">
      <div>
        <img class="w-75" src="../assets/img/flagCK.png" alt="Cardio Kings">
        <p class="fs-5 fs-md-2 pt-3 fw-bold">Cardio Kings</p>
      </div>
