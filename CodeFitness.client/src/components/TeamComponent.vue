<template>
  ...
  <section v-else class="row justify-content-around bg-neutral-dark">
    <div :class="{ 'bg-light': account.community == 'Cardio Kings' }"
    ...
    <div :class="{ 'bg-light': account.community == 'Weight Warriors' }"
      class="col-10 col-md-3 bg-neutral-light my-4 p-3 text-center flag">
    ...
    <div :class="{ 'highlight': account.community == 'Legion of Leisure' }"
      class="col-10 col-md-3 bg-neutral-light my-4 p-3 text-center flag">
