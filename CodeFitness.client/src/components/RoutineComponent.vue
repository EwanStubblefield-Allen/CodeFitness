  ...
  <section class="row justify-content-center text-break">
    <div class="col-12 col-md-9">
        ...
        <div v-for="r in  showAmount " :key="r" class="col-12 col-md-6 col-lg-4 pb-3">
          <div class="routine-bg rounded">
            ...
            <div class="routine-details p-2">
              ...
              <div v-else-if="routinesProp[r - 1].activities?.length" class="text-end">
              ...
              <div v-else class="text-end">
                <button class="btn btn-action" type="button" disabled>No Activities</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section v-else class="row">
        <div v-for="r in routinesProp" :key="r.id" class="col-12 col-md-6 col-lg-4 pb-3">
          <div class="routine-bg rounded">
            ...
            <div class="routine-details p-2">
              ...
              <div v-if="account.id != r.accountId" class="text-end">
                <button @click="setActiveRoutine(r)" class="btn btn-action" type="button">Routine Details</button>
              </div>

              <div v-else-if="r.activities?.length" class="text-end">
