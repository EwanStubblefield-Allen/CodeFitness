    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav ms-auto">
        <li>
          ...
          <router-link :to="{ name: 'Account' }" v-if="account.community" class="btn text-success lighten-30 selectable text-uppercase me-md-5">
            Account
          </router-link>
          <router-link :to="{ name: 'About' }" class="btn text-success lighten-30 selectable text-uppercase me-md-5">
            About
          </router-link>
